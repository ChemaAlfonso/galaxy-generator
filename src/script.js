    ...
    material = new THREE.ShaderMaterial({
        vertexShader: `
            ...
            void main() {
                ...
                // Get the vert distance
                float distanceToCenter = length(bodyPosition.xz);

                // Required offset based on distance to center & time
...
gui.add( debugObject, 'randomnessPower', 0, 10, .001 ).onFinishChange(generateGalaxy).name('Randomness Power')
